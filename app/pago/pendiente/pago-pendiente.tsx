    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 15, color: '#888', margin: '0 0 32px', lineHeight: 1.6 }}>
          Tu pago está siendo procesado. Esto puede demorar algunas horas. Te avisaremos por email cuando se confirme.
        </p>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 13, color: '#92400E', margin: 0, fontWeight: 600 }}>
            No realices otro pago hasta recibir la confirmación
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <a
            href={`https://wa.me/541133802658?text=${encodeURIComponent('¡Hola! Realicé un pago que quedó pendiente y quiero saber el estado.')}`}
            target="_blank"
